...
{
	_chatStringAllocator.Init((uptr)(1 << 20) * (uptr)demoCount, "ParserPlugInChat::Strings");
	FinalAllocator.Init((uptr)(1 << 20) * (uptr)demoCount, "ParserPlugInChat::ChatMessagesArray");
