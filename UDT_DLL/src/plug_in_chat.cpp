...
{
	_stringAllocator.Init(ComputeReservedByteCount(1 << 15, 1 << 17, 16, demoCount), "ParserPlugInChat::Strings");
	ChatEvents.Init(ComputeReservedByteCount(1 << 15, 1 << 17, 16, demoCount), "ParserPlugInChat::ChatMessagesArray");
}
