...
private:
	...
	void ParseETMainWeapStats();
	void ParseLegacyWeapStats();
	void ParseETScores();
	void ParseETSC();
	void ParseETSCHeader(const udtString& message);
	void ParseETSCStatsPlayer(const udtString& message);
	void ParseETSCStatsTeam(const udtString& message);
